...
<div class="pdf_section" id="pdf_section">
        ...
        <div class="col-4">
        <p class="s1" style="padding-left: 13px; margin-right: 10px; text-align: left">SALES INVOICE</p>
        <div style="font-size:10px;  text-align: left;">
        <h2
        style="padding-left: 12px; text-align: left; font-size:11px;">
        Invoice Date
        </h2>
        <p style="padding-left: 13px; text-align: left; font-size:11px;">
        ...
        <h2 style="padding-left: 13px; text-align: left; font-size:11px;">Account
        </h2>
        <p style="padding-left: 13px; text-align: left; font-size:11px;">
        ...
        <table style="width:100%">
            <thead>
            <tr>
                <th style="width:350px">Descripxion</th>
