...
<div class="pdf_section" id="pdf_section">
        ...
        <div class="col-4 s3" style="font-size:9px; text-align:left; position: absolute; margin-top:-110px; padding-left: 445px;">
            <h2  style="padding-top: 45px; text-align: left; font-size:11px;font-family: Calibri, sans-serif;">
            ...
            <br>
            <h2 style=" text-align: left; font-size:11px;font-family: Calibri, sans-serif;">
            Vat No: {{$companydata['vat_number']}}
            </h2>
            <h2 style=" text-align: left; font-size:11px;font-family: Calibri, sans-serif;">
            t: {{$companydata['contact_mobile']}}
            </h2>
            <p style="text-align: left; font-size:11px;font-family: Calibri, sans-serif;">
        ...
        <div class="container1">
            <div class="row">
                ...
                <div class="col-4" style="padding-right: 50px; float:right; margin-top:30px">
                        <p class="s1" style="font-family: Calibri, sans-serif; margin-right: 10px; text-align: left">{{ $invoicetitle }}</p>
                        <br>
                        <div style="font-size:10px;  text-align: left;">
                        <h2 style="font-family: Calibri, sans-serif;font-weight:bold">
                        Invoice Date
                        </h2>
                        <p style=" text-align: left; font-family: Calibri, sans-serif;">
                        <span>{{ $salesdata['issue_date'] }}</span></p>
                        
                        <h2 style="font-family: Calibri, sans-serif;font-weight:bold">
                        Invoice Number
                        </h2>
                        <p style="font-family: Calibri, sans-serif;">
                            <span>{{ $salesdata['invoiceno']  }}</span>
                        </p>
                        <h2 style="font-family: Calibri, sans-serif;font-weight:bold">Account
                        </h2>
                        <p style="font-family: Calibri, sans-serif;">
