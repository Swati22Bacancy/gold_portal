    ...
    <div class="mt-2 mb-4">
      <div class="">
          <div class="table-responsive">
              <table class="table" id="partiallypurchase-datatable" width="100%" cellspacing="0">
                  <thead>
                      <tr>
  ...
  mounted(){
    ...
    const unwatch = this.$watch('purchases', (purchases) => {
      ...
      this.$nextTick(() => {
          ...
          const table = $('#partiallypurchase-datatable').DataTable({
            //"bFilter": false,
            "bLengthChange": false,
            // pageLength: 5,
...
#partiallypurchase-datatable thead
{
  background: #3376C2;
  color: #fff;
  font-size: 13px;
...
#partiallypurchase-datatable thead tr th 
{
