  ...
  <div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
      ...
      <div class="col-md-6" style="text-align:right">
        <router-link to="/createinvoice"><button type="button" class="btn admin-btn mobile-mb" style="background-color: #7ADAAA !important;"><i class="fas fa-plus" style="margin-right: 5px;"></i>Add Customer</button></router-link>
