<template>
  <div>
    <form class="crt-invoice" @submit.prevent="create_deliverynote">
    <!-- Page Heading -->
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">New Delivery Note</h1>
        <div>
          <button type="button" @click="create_deliverynote()" class="btn admin-btn mobile-mb btn-nwidth" style="background-color: #7ADAAA !important;">Save</button>
      ...
      <div class="row">
        <div class="col-md-12 crreatedeliverynote-div">
          ...
          <div class="row">
                ...
                <div class="input-group mb-3 d-flex">
                  ...
                  <div class="select-group-append">
                      <div class="input-icons">
                        <button type="button" class="btn-modal" data-toggle="modal" data-target="#addcrreatedeliverynote">
                      ...
                      <!-- Modal -->
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-header">
                                <h6 class="modal-title" id="addcrreatedeliverynote">Add Customer</h6>
            ...
            <div class="col-md-2">
              <div class="form-group form-text">
                ...
                />
                <label for="invno" class="static-value">DN -</label>
                <span v-if="$v.formdata.invoiceno.$error" class="text-danger">Please Enter delivery note no</span>
              </div>
            </div>
            <div class="col-md-2">
              <div class="form-group">
      ...
      <div class="row mt-3">
        <div class="col-md-12 crreatedeliverynote-div pb-3" style="padding:0">
          <div class="">
            <div class="table-responsive table-div mb-2">
              <table class="table" id="crreatedeliverynote-datatable" width="100%" cellspacing="0" style="margin-bottom:0">
                  <thead>
                    <tr>
                      <th>Type</th>
                      <th>Product</th>
                  ...
                  <tbody>
                    <tr v-for="(invoice_item, key) in invoice_items" :key="key" class="table-row">
                        ...
                        <td><div class="modal-crreatedeliverynote">
...
export default {
  ...
  methods:
  {
    ...
    async create_deliverynote() {
      ...
      if(price_difference_count>0)
      {
        ...
        try {
          ...
          const response = await axios.post("create_deliverynote", this.postdata);
          let message =
              "Delivery Note has been successfully created.";
    ...
    getInvoicekey() {
        return axios.get("get_note_key").then(response => {
...
#crreatedeliverynote-datatable thead {
    background: #3376C2;
    color: #fff;
    font-size: 13px;
}
#crreatedeliverynote-datatable thead tr th {
    font-weight: 100 !important;
}
#crreatedeliverynote-datatable
{
  font-size: 13px;
  color: #000;
}
.crreatedeliverynote-div
{
  background: #fff;
