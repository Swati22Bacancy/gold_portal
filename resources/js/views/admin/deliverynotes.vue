  ...
  <div>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-3">
      <div class="col-md-6">
        <div class="row">
          <div class="col-md-2 mobile-mb">
            <h1 class="h3 mb-0 text-gray-800">Delivery Notes</h1>
          </div>
      ...
      <div class="col-md-6" style="text-align:right">
        <router-link to="/create_deliverynote"><button type="button" class="btn admin-btn mobile-mb" style="background-color: #7ADAAA !important;"><i class="fas fa-plus" style="margin-right: 5px;"></i>Create Delivery Note</button></router-link>
