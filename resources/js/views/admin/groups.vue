                        ...
                        <table class="table" id="group-datatable" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <tr v-for="group in groups" :key="group.id">
                                    ...
                                    <td>{{group.name}}</td>
                                    <td><router-link :to="{name : 'editgroup', params: {id : group.id}}"><span class="material-symbols-outlined" style="margin-right: 10px;color: #3376C2;">visibility</span></router-link>
