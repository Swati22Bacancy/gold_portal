    ...
    <div class="mt-2 mb-4">
      <div class="">
          <div class="table-responsive">
              <table class="table" id="partialsales-datatable" width="100%" cellspacing="0">
                  <thead>
                      <tr>
  ...
  mounted(){
    ...
    const unwatch = this.$watch('sales', (sales) => {
      ...
      this.$nextTick(() => {
          ...
          const table = $('#partialsales-datatable').DataTable({
            //"bFilter": false,
            "bLengthChange": false,
            // pageLength: 5,
