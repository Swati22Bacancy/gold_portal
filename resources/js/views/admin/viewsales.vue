<template>
  <div class="row">
   ...
   <section slot="pdf-content">
    ...
    <h2  style="padding-top: 2pt; padding-left: 13pt;text-indent: -1pt;text-align: left; font-size:11px;">
      215 The Broadway <br>Southall,<br> Middlesex</h2>
    ...
    <p style="padding-left: 13pt; text-indent: 0pt; text-align: left; font-size:11px;">
      <a href="mailto:accounts@gold-bank.co.uk" class="a" target="_blank">e: </a>
      <a href="mailto:accounts@gold-bank.co.uk" target="_blank">accounts@gold-bank.co.uk</a>
    </p>
    </div>
    ...
    <p style="padding-left: 12pt; text-indent: 0pt; text-align: left; font-size:11px;">
      30 Howden Avenue<br> Skellow
    </p>
    <p style="padding-left: 12pt; text-indent: 0pt; text-align: left; font-size:11px;">
      Doncaster<br> Yorkshire<br>DN6 8LJ<br> GBR
    </p>
  </div>
    <div class="col-4">
    ...
    <div class="container" style="font-size:10px">
      <table>
        <thead>
          ...
          <tbody>
   <tr>
    <td>1 x Gold Sovereign Coin (8g) (Mixed<br> Years)</td>
    <td></td>
    <td>393</td>
  </tr><br><br>
  <tr>
  ...
  <tr>
    ...
    <p style="text-indent: 0pt;text-align: justify;font-size: 11px;">Payment Terms:</p>
    <p style=" text-indent: 0pt; text-align: justify; font-size: 11px;">
