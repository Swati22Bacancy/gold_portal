                ...
                >
                    <div>
                                ...
                                <div style=" padding: 0px 2%;">
                                    ...
                                    >
                                        <div class="row">
                                            ...
                                            >
                                                <h2
                                                    style="padding-top: 45px; padding-left: 13pt;text-indent: -1pt;text-align: left; font-size:11px;"
                                                >
                                                    {{
                                                ...
                                                <h2
                                                    style="padding:0;padding-left: 13pt; text-indent: 0pt; text-align: left; font-size:11px;"
                                                >
                                                    {{ companydata.postcode }}
                                                </h2>
                                                <h2
                                                    style="padding-left: 13pt; text-indent: 0pt; text-align: left; font-size:11px;"
                                                >
                                                    Vat No:
                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <p
                                                    class="s1"
                                                    style="padding-left: 13pt; text-indent: 0pt; margin-right: 10px; text-align: left"
                                                >
                                                    SALES INVOICE
                                                </p>
                                                <div
                                    ...
                                    <div class="container s3">
                                        ...
                                        <p style=" text-indent: 0pt; text-align: justify; font-size: 12px;">
                                            ...
                                            will be charged at 4% per month.<br />
                                        ...
                                        <br /><br />
                                        <p
                                            style=" text-indent: 0pt; text-align: left; font-size: 11px;"
                                        >
                                            Signed:
                                            <img
                                                :src="
                                    ...
                                    >
                                        ...
                                        <div class="flex-parent">
                                            ...
                                            <div class="box">
                                                ...
                                                <p class="box_size">
                                                    <span style="font-weight:bold">Account number </span>8312378352<br />
                                                    <span style="font-weight:bold">Bank code
                                                        (SWIFT/BIC)</span>CMFGUS33<br />
                                                    <span style="font-weight:bold">ABA Routing No</span>084009519
                                                </p>
                                            </div>
                                        </div>
                                        <br /><br />
                        ...
                        <span
                            ...
                            v-if="!sign_flag"
                            title="Add Signature"
                            style="color:#00AA5B; background-color: #EDF2F6; margin:3% 0% 3% 0%; border-radius:50%; padding: 11%; font-size: 23px;cursor:pointer;"
                            data-toggle="modal"
                            data-target="#dosign"
                            >draw</span
                        >
                ...
                <div class="col-md-12 viewsales-div">
                    <div class="row" style="padding-bottom:40px">
                        ...
                        >
                            ...
                            <span>{{
                                dateFormateChanger(formdata.due_date)
                            }}</span>
                        </div>
                        <div
                            class="col-md-2"
                        ...
                        <div class="col-md-2">
                            ...
                            <span>
                                <button
                                    type="button"
                                    v-if="invoice_status == 'Over Paid'"
                                    class="btn table-btn"
                                    style="margin-left: auto;width: 100px;background-color: #ffa500 !important;"
                                >
          ...
          <div class="col-md-2">8000</div>
                ...
                >
                    <tbody>
                        ...
                        >
                            <td>
                                {{
                                    dateFormateChanger(salepayment.payment_date)
                                }}
                            </td>
                            ...
                            <td
                                ...
                                "
                            >
                                <span v-if="salepayment.action == 'Refund'"
                                    >-
                                </span>
                                <i
                                    class="fa fa-pound-sign"
                        ...
                        <tr v-for="(invoice_item, k) in invoice_items" :key="k">
                            ...
                            <td>
                                ...
                                >
                                    ...
                                    <option value="Cheque" v-if="!cashSelected"
                                        >Cheque</option
                                    >
                                </select>
                            </td>
                            ...
                            <tr>
                                ...
                                <td style="color:#3376C2">
                                    <div class="choose-cont">
                                        ...
                                        <br />
                                        <div
                                            v-for="(url, index) in urlArr[1]"
                                            :key="url"
                                            class="previewContainer"
                                        >
                                            <img
                                                v-if="url.fileType == 'image'"
                                                :src="url.url"
                                                class="imagePreview"
                                            />
                                            <img
                                ...
                                <td>
                                    <i
                                        class="fas fa-upload"
                                        @click="uploadfile(1)"
                                        style="font-size:20px;margin-right:20px;color:green;"
                                    ></i>
                                    <i
                                        class="fa fa-trash"
                                        aria-hidden="true"
                                        style="font-size:20px;margin-right:5px;color:red;"
                                    ></i>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td style="color:#3376C2">
                                    ...
                                    <div class="upload_vat">
                                        <div
                                            v-for="vatdoc in kycdocs.vatdocs"
                                            :key="vatdoc"
                                            class="previewContainer"
                                        >
                                            <img
                ...
                >
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td>
                                {{ dateFormateChanger(salehistory.log_date) }}
                            </td>
                            <td>
                                {{ salehistory.firstname }}
                                {{ salehistory.lastname }}
                            </td>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6
                                class="modal-title"
                                id="deleteConfirmationFileLabel"
                            >
                                Confirmation
                            </h6>
                            <button
            ...
            >
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h6 class="modal-title" id="dosignh1">
                                Add Signature
                            </h6>
                            <button
                                type="button"
                    ...
                    <button @click="undo">Undo</button>
                            ...
                            <span v-if="no_sign" class="text-danger"
                                >Please add signature</span
                            >
                            <br />
    ...
    methods: {
        ...
        async save() {
            ...
            if (isEmpty) {
                ...
                const response = await axios.post("add_salessignature", {
                    signature: data,
        ...
        async save_payment(index) {
            ...
            if (response.data.id) {
                ...
                if (this.payaction == "Receive") {
                    this.due_payment =
                        this.due_payment -
                        this.invoice_items[index].totalamount;
                    this.paymentclass = "receive_class";
                } else {
                    if (this.over_paid < 0) {
                        this.due_payment =
                            parseFloat(this.over_paid) +
                            parseFloat(this.invoice_items[index].totalamount);
                        this.over_paid =
                            this.due_payment > 0
                                ? 0
                                : parseFloat(Math.abs(this.over_paid)) -
                                  parseFloat(
                                      this.invoice_items[index].totalamount
                                  );
                    } else {
        ...
        async uploadfile(index) {
            ...
            const response = await axios.post(
                "upload_kyc",
                objectToFormData(this.postFormData)
            );
            ...
            if (response.data.id) {
                ...
                let toast = Vue.toasted.show("Please choose file", {
                    theme: "toasted-error",
                    position: "top-center",
                    duration: 5000
                });
        ...
        download(image) {
            axios
                .get("/download-kyc?image=" + image, { responseType: "blob" })
                .then(response => {
