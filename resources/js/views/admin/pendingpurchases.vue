    ...
    <div class="mt-2 mb-4">
      <div class="">
          <div class="table-responsive">
              <table class="table" id="pendingpurchase-datatable" width="100%" cellspacing="0">
                  <thead>
                      <tr>
  ...
  mounted(){
    ...
    const unwatch = this.$watch('purchases', (purchases) => {
      ...
      this.$nextTick(() => {
          ...
          const table = $('#pendingpurchase-datatable').DataTable({
            //"bFilter": false,
            "bLengthChange": false,
            // pageLength: 5,
...
#pendingpurchase-datatable thead
{
  background: #3376C2;
  color: #fff;
  font-size: 13px;
...
#pendingpurchase-datatable thead tr th 
{
